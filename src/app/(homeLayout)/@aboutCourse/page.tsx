    ...
    return (
        <section className='mt-24 w-[90%] mx-auto'>
            <div className='w-[70%] mx-auto text-center'>
                <h1 className='text-4xl w-[80%] mx-auto tracking-wide leading-snug font-semibold '>আমাদের কোর্সের সুবিধা এবং সার্টিফিকেশন</h1>
            ...
            <div className='w-full flex justify-between gap-5 items-center mt-12'>
